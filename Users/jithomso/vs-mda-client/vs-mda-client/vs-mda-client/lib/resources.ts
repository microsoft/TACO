...
export function init(language: string, resourcesDir?: string) {
    if (!resourcesDir) {
...
function bestLanguageMatchOrDefault(language: string, resourcesDir: string): string {
    ...
    fs.readdirSync(resourcesDir).filter(function (c) {
...
function loadLanguage(language: string, resourcesDir: string) {
