...
declare module Express {
    ...
    interface Request extends NodeJSHttp.ServerRequest {
    ...
    interface Response extends NodeJSHttp.ServerResponse {
        /**
         * Set status `code`.
         *
         * @param code
    ...
    interface Application extends IRouter<Application> {
        ...
        listen(port: number, hostname: string, callback?: Function): NodeJSHttp.Server;
        listen(port: number, callback?: Function): NodeJSHttp.Server;
        listen(path: string, callback?: Function): NodeJSHttp.Server;
        listen(handle: any, listeningListener?: Function): NodeJSHttp.Server;
