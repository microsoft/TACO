...
describe("plist", function (): void {
    var testDir: string = path.join(os.tmpdir(), "taco-remote-lib", "plist");
    ...
    it("should create plist files correctly", function (): void {
        var outFile: string = path.join(testDir, "plist", "actualEnterpriseApp.plist");
        ...
        var expectedContents: string = UtilHelper.readFileContentsSync(path.join(__dirname, "resources", "plist", "expectedEnterpriseApp.plist"));
        var actualContents: string = UtilHelper.readFileContentsSync(outFile);
    ...
    it("should update the App Bundle Version correctly", function (done: MochaDone): void {
        ...
        var appPlistFile: string = path.join(testDir, "plist", "cordovaApp.plist");
