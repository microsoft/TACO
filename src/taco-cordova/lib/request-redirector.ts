...
interface IRequestRedirector {
    getPackageToServeRequest(buildInfo: BuildInfo, req: express.Request): TacoRemoteLib.IRemoteLib;
};
class RequestRedirector implements IRequestRedirector {
    public getPackageToServeRequest(buildInfo: BuildInfo, req: express.Request): TacoRemoteLib.IRemoteLib {
        ...
        return require("taco-remote-lib");
    }
}

var instance: IRequestRedirector = new RequestRedirector();
