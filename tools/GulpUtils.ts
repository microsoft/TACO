...
class GulpUtils {
    ...
    private static testCordovaExemptText: string = "TestCordovaExempt"; // test directory
    ...
    public static runAllTests(modulesToTest: string[], modulesRoot: string, failTestsAtEnd: boolean, reporter: string, testCordova: string): Q.Promise<any> {
        ...
        return GulpUtils.chainAsync<string>(modulesToTest, (moduleName: string) => {
            ...
            if (testCordova) {
                ...
                fs.appendFileSync(mochaOptFile, " " + GulpUtils.mochaTestInvert + " " + GulpUtils.testCordovaExemptText); // i.e. run all tests except for TestCordovaExempt
